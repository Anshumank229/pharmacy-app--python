...
# ==========================================
# MEDIA FILES — Supabase Storage in production, local in dev
# ==========================================
...
# Local fallback (used in dev when Supabase env vars are not set)
MEDIA_URL  = '/media/'
...
if not DEBUG:
    if ADMIN_API_KEY == 'change-me-in-production':
        print('FATAL: Set ADMIN_API_KEY in your environment!', file=sys.stderr)
        sys.exit(1)
    if SECRET_KEY == 'fallback-dev-key-change-in-production':
        print('FATAL: Set DJANGO_SECRET_KEY in your environment!', file=sys.stderr)
        sys.exit(1)
    if not SUPABASE_URL or not SUPABASE_KEY:
        print('FATAL: Set SUPABASE_URL and SUPABASE_KEY in your environment!', file=sys.stderr)
        sys.exit(1)
